          ...
          <div className="modal modal--wide" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal__body">
              <div className="table">
                ...
                <div className="table__body">
                  <div className="table__row"><div className="table__cell">{t.confirm.previewLanguage}</div><div className="table__cell"><div className="lang-switch confirm-language-switch">{(['ru', 'kz', 'en'] as Lang[]).map((code) => (<button key={code} type="button" className={`lang-chip ${confirmLang === code ? 'lang-chip--active' : ''}`} onClick={() => setConfirmLang(code)}>{langLabels[code]}</button>))}</div></div></div>
